    ...
    for (i = 0; i < users.length; i++) {
        if (users[i].isEvaluated) {
          ...
          if (window.location == "https://ccs.csivit.com/usertests/technical") {
                document.getElementById("user").innerHTML += "<tr><td><a href='/evaluate/" + users[i].regno + "/technical'>" + users[i].regno + "</a></td><td>" + users[i].name + "</td><td>" + users[i].phone + "</td><td>" + users[i].isEvaluated + "</td></tr>";

          }
          else if (window.location == "https://ccs.csivit.com/usertests/management") {
              document.getElementById("user").innerHTML += "<tr><td><a href='/evaluate/" + users[i].regno + "/management'>" + users[i].regno + "</a></td><td>" + users[i].name + "</td><td>" + users[i].phone + "</td><td>" + users[i].isEvaluated + "</td></tr>";

          } else if (window.location == "https://ccs.csivit.com/usertests/design") {

              document.getElementById("user").innerHTML += "<tr><td><a href='/evaluate/" + users[i].regno + "/design'>" + users[i].regno + "</a></td><td>" + users[i].name + "</td><td>" + users[i].phone + "</td><td>" + users[i].isEvaluated + "</td></tr>";
